...
class Sheet:
    ...
    def write_state_data(self, state_data):
        self.sheet.update_cell(self.row_to_write, 13, state_data['Alabama'])
        self.sheet.update_cell(self.row_to_write, 14, state_data['Alaska'])
        self.sheet.update_cell(self.row_to_write, 15, state_data['Arizona'])
        self.sheet.update_cell(self.row_to_write, 16, state_data['Arkansas'])
        ...
        self.sheet.update_cell(self.row_to_write, 25, state_data['Idaho'])
        self.sheet.update_cell(self.row_to_write, 26, state_data['Illinois'])
        self.sheet.update_cell(self.row_to_write, 27, state_data['Indiana'])
        self.sheet.update_cell(self.row_to_write, 28, state_data['Iowa'])
        ...
        self.sheet.update_cell(self.row_to_write, 32, state_data['Maine'])
        self.sheet.update_cell(self.row_to_write, 33, state_data['Montana'])
        self.sheet.update_cell(self.row_to_write, 34, state_data['Nebraska'])
        self.sheet.update_cell(self.row_to_write, 35, state_data['Nevada'])
        self.sheet.update_cell(self.row_to_write, 36, state_data['New Hampshire'])
        self.sheet.update_cell(self.row_to_write, 37, state_data['New Jersey'])
        self.sheet.update_cell(self.row_to_write, 38, state_data['New Mexico'])
        self.sheet.update_cell(self.row_to_write, 39, state_data['New York'])
        ...
        self.sheet.update_cell(self.row_to_write, 42, state_data['Ohio'])
        self.sheet.update_cell(self.row_to_write, 43, state_data['Oklahoma'])
        self.sheet.update_cell(self.row_to_write, 44, state_data['Oregon'])
        self.sheet.update_cell(self.row_to_write, 45, state_data['Maryland'])
        self.sheet.update_cell(self.row_to_write, 46, state_data['Massachusetts'])
        self.sheet.update_cell(self.row_to_write, 47, state_data['Michigan'])
        self.sheet.update_cell(self.row_to_write, 48, state_data['Minnesota'])
        self.sheet.update_cell(self.row_to_write, 49, state_data['Mississippi'])
        self.sheet.update_cell(self.row_to_write, 50, state_data['Missouri'])
        ...
        self.sheet.update_cell(self.row_to_write, 58, state_data['Vermont'])
        self.sheet.update_cell(self.row_to_write, 59, state_data['Virginia'])
        self.sheet.update_cell(self.row_to_write, 60, state_data['Washington'])
        self.sheet.update_cell(self.row_to_write, 61, state_data['West Virginia'])
        self.sheet.update_cell(self.row_to_write, 62, state_data['Wisconsin'])
